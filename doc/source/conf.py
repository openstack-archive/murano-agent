...
sys.path.insert(0, os.path.abspath('../../muranoagent'))
...
#
# Version info
#from muranoagent.version import version_info as s_version
...
htmlhelp_basename = 'MuranoAgentDoc'
...
#latex_documents = [
#    ('index', 'muranoagent.tex', u'Murano Agent',
